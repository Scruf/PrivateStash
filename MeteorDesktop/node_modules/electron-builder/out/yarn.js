...
let installOrRebuild = exports.installOrRebuild = (() => {
    var _ref = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (options, appDir, electronVersion, platform, arch) {
        ...
        const args = (0, (_electronBuilderUtil || _load_electronBuilderUtil()).asArray)(options.npmArgs);
...
let rebuild = exports.rebuild = (() => {
    var _ref2 = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (appDir, electronVersion) {
        ...
        const nativeDeps = yield (_bluebirdLstC2 || _load_bluebirdLstC2()).default.filter(pathToDep.values(), function (it) {
        ...
        if (isYarn) {
            ...
            yield (_bluebirdLstC2 || _load_bluebirdLstC2()).default.each(nativeDeps, function (dep) {
