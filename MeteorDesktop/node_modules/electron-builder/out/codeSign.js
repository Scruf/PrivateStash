...
let createCustomCertKeychain = (() => {
    var _ref2 = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
        ...
        const results = yield (_bluebirdLstC2 || _load_bluebirdLstC2()).default.all([(0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("security", ["list-keychains"]), (0, (_fsExtraP || _load_fsExtraP()).copy)(_path.join(__dirname, "..", "certs", "root_certs.keychain"), tmpKeychainPath).then(function () {
...
let getValidIdentities = (() => {
    var _ref5 = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (keychain) {
        ...
        if (result == null || keychain != null) {
            ...
            result = (_bluebirdLstC2 || _load_bluebirdLstC2()).default.all([(0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("security", addKeychain(["find-identity", "-v"])).then(function (it) {
