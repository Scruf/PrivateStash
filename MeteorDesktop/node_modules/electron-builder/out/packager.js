...
class Packager {
    ...
    build() {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            _this.appDir = yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).computeDefaultAppDirectory)(_this.projectDir, (0, (_electronBuilderUtil || _load_electronBuilderUtil()).use)((0, (_metadata || _load_metadata()).getDirectoriesConfig)(_this.devMetadata), function (it) {
                return it.app;
            }));
            ...
            _this.electronVersion = yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).getElectronVersion)(_this.devMetadata, devPackageFile);
            _this.appInfo = new (_appInfo || _load_appInfo()).AppInfo(_this.metadata, _this.devMetadata, _this);
            const cleanupTasks = [];
    ...
    doBuild(cleanupTasks) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            const distTasks = [];
            const outDir = _path.resolve(_this2.projectDir, (0, (_electronBuilderUtil || _load_electronBuilderUtil()).use)((0, (_metadata || _load_metadata()).getDirectoriesConfig)(_this2.devMetadata), function (it) {
                return it.output;
            }) || "dist");
