...
class ArchiveTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            packager.dispatchArtifactCreated(outFile, isMac ? packager.generateName2(format, "mac", true) : packager.generateName(format, arch, true, packager.platform === (_electronBuilderCore || _load_electronBuilderCore()).Platform.WINDOWS ? "win" : null));
        })();
    }
}
