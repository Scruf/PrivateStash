    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (isUseDocker) {
                ...
                "-v", `${ _this.outDir }:/out`, "electronuserland/electron-builder:latest", "/bin/bash", "-c", `snapcraft --version && cp -R /out/${ _path.basename(snapDir) } /s/ && cd /s && snapcraft snap --target-arch ${ (0, (_electronBuilderCore || _load_electronBuilderCore()).toLinuxArchString)(arch) } -o /out/${ snapName }`], {
