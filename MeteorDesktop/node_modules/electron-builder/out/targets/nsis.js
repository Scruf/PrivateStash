...
class NsisTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    constructor(packager, outDir) {
        ...
        this.publishConfigs = this.packager.computePublishConfigs(this.options);
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (publishConfigs != null) {
                for (const publishConfig of publishConfigs) {
                    ...
                    const sha2 = yield sha256(installerPath);
                    const channel = publishConfig.channel || "latest";
                    const updateInfoFile = _path.join(_this3.outDir, `${ channel }.yml`);
                ...
                yield (0, (_fs || _load_fs()).unlinkIfExists)(_path.join(_this3.outDir, `latest.yml`));
            }
