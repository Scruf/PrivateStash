...
exports.tmpDirCounter = exports.computeDefaultAppDirectory = exports.getElectronVersion = exports.debug7z = exports.debug = undefined;
...
let getElectronVersion = exports.getElectronVersion = (() => {
    var _ref = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (packageData, packageJsonPath) {
        ...
        for (const name of ["electron", "electron-prebuilt", "electron-prebuilt-compile"]) {
            try {
                return (yield (0, (_fsExtraP || _load_fsExtraP()).readJson)(_path.join(_path.dirname(packageJsonPath), "node_modules", name, "package.json"))).version;
            } catch (e) {
                if (e.code !== "ENOENT") {
...
let computeDefaultAppDirectory = exports.computeDefaultAppDirectory = (() => {
    var _ref2 = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (projectDir, userAppDir) {
        if (userAppDir != null) {
    ...
    return function computeDefaultAppDirectory(_x3, _x4) {
...
function getCacheDirectory() {
    if (process.platform === "darwin") {
        ...
        return _path.join(process.env.LOCALAPPDATA, "electron-builder", "cache");
    } else {
